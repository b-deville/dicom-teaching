\section{Histoire du DICOM}
	...
	\frame
	{
		...
		\begin{itemize}
			...
			\item Actuellement en version $2011$ : on parle des versions par leur ann\'ee (officiellement, toujours en version 3 Ð PS3)
			\item Diversit\'e des \'equipements support\'es : RX, CT, IRM, US, PET, SPECT, Angio, ECG,?
			\item Adopt\'e par de nombreux constructeurs : GE, Siemens, Philips, Toshiba,?
		\end{itemize}
	}
