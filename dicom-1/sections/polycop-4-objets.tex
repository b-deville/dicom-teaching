...
\frame
{
 	\frametitle{Information Object Definition}
  	...
  	\begin{description}
    	\item[Normalized IOD] Repr\'esente une entit\'e unique du monde r\'eel (patient, visite, examen, r\'esultat, interpr\'etation,\ldots).
		Rarement appliqu\'e en pratique : cause complexit\'e et perte de performance.
    	\item[Composite IOD] Repr\'esente certains d\'etails de plusieurs objets du monde r\'eel et les relations entre ces objets (nom du patient, date de l'examen,\ldots)
		\item[Attributes] Les attributs d'un IOD d\'ecrivent les propri\'et\'es d'un \'el\'ement (instance d'un objet) du monde r\'eel.
  	\end{description}
}
...
\frame
{
	...
	\begin{itemize}
		...
		\item Data Element
		\begin{itemize}
			\item Étiquette d'identification (\emph{Tag}) contenant deux num\'eros.
