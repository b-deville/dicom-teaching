\section{Histoire du DICOM}
	...
	\frame
	{
		...
		\begin{itemize}
			...
			\item Actuellement en version $2015$ : on parle des versions par leur ann\'ee (officiellement, toujours en version 3, ou PS3).
			\item Diversit\'e des \'equipements support\'es : RX, CT, IRM, US, PET, SPECT, Angio, ECG, BTO, \ldots
			\item Adopt\'e par de nombreux constructeurs : GE, Siemens, Philips, Toshiba, Hologic, \ldots
		\end{itemize}
	}
