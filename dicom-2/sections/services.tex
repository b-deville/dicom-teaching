...
\frame
{
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item op\'erations (e.g. \emph{store}) ;
...
\frame
{
	...
	\begin{itemize}
		...
		\begin{description}
			\item[SCU] Service Class User (le client/utilisateur)
			\item[SCP] Service Class Provider (le serveur/fournisseur)
		\end{description}
...
\frame
{
	...
	Par exemple, une station d'interpr\'etation peut être :
	\begin{itemize}
