\section{Repr\'esentations informatiques}
	...
	\frame
	{
		...
		Exemples :
		\begin{description}
			\item<2-> $2017_{10} = 2\cdot10^3 + 0\cdot10^2 + 1\cdot10^1+7\cdot10^0$
...
\frame
{
	...
	\begin{itemize}
		...
		\end{itemize}
		\item<6-> Exemple avec l'entier 2017 :
		\begin{itemize}
			\item<7-> Sur 2 octets
			\begin{itemize}
				\item<8-> Little Endian : 0x07E1
				\item<9-> Big Endian : 0xE107
			\end{itemize}
			\item<10-> Sur 4 octets
			\begin{itemize}
				\item<11-> Little Endian : 0x000007E1
				\item<12-> Big Endian : 0xE1070000
			\end{itemize}
		\end{itemize}
	\end{itemize}
}
